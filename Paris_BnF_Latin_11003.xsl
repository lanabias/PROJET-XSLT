            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="home2.html">Accueil</a>
                        </li>
...
<!-- TEMPLATE CONTENANT LA PAGE D'ACCUEIL DU SITE -->
    <xsl:template name="home">
        ...
        <xsl:result-document href="out/home2.html" method="html" indent="yes">
            <html lang="fr">   
        ...
        <xsl:result-document href="out/tableau_relations.html">
            <html lang="fr">
                ...
                <body style="margin: 2em 20em 5em 20em; font-family: 'Roboto', serif;">
                    ...
                    <div style="margin: 2em 0 2em 0;">
                        <!-- BOUCLE N°1: GROUPER LES RELATIONS PAR CATEGORIE, LES TRIER PAR ORDRE ALPHABÉTIQUE -->
